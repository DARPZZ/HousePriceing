...
namespace HousePriceing.Helpers.Scrapers.HouseScrapers
{
    public class LatestSalePrice : AbStractScraper
    {
        ...
        public async Task<Dictionary<string,string>> GetLatestSalePrice()
        {
            ...
            HtmlNode pris = htmlDoc.DocumentNode.SelectSingleNode("/html/body/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/p[1]");
            HtmlNode dato = htmlDoc.DocumentNode.SelectSingleNode("/html/body/div[4]/div[2]/div[1]/div[1]/div[2]/div[2]/p[2]");
